<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UrlShortener.Default" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="input-group">
            ...
            <span class="input-group-btn" style="width: 15%">
                ...
                <asp:LinkButton ID="Button2" class="btn btn-primary" runat="server" OnClick="Button2_Click">
                        <i class="fas fa-align-justify" id="list-icon" ></i> Show List
                </asp:LinkButton>
            </span>
        </div>
